  ...
  theme: {
  	extend: {
  		colors: {
  			...
  			input: '#262626', // Dark gray input border
  			ring: '#6D28D9', // Accent color for focus rings
  			...
  			muted: {
  				...
  				foreground: '#A3A3A3', // Lighter gray for muted text
  			},
  			accent: {
  				DEFAULT: '#6D28D9', // Accent color
  				foreground: '#FAFAFA',
  			},
  			popover: {
  				DEFAULT: '#1A1A1A', // Popover background
  				foreground: '#FAFAFA',
  			},
  			card: {
